...
// This line specifies that the crate should not use the Rust standard library
// if the "std" feature is not enabled. This is common in no-std environments like embedded systems.
