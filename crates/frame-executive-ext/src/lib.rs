...
use sp_runtime::{
	generic::Digest,
	traits::{
		Applyable, CheckEqual, Checkable, Dispatchable, Header, NumberFor, One, ValidateUnsigned,
		Zero,
	},
...
use melo_core_primitives::traits::ExtendedBlock as ExtendedBlockT;
...
type BlockNumber<System> = <<<System as frame_system::Config>::Block as sp_runtime::traits::Block>::Header as sp_runtime::traits::Header>::Number;
...
impl<
		System: frame_system_ext::Config + EnsureInherentsAreFirst<Block>,
		Block: ExtendedBlockT<
			BlockNumber<System>,
			Header = frame_system_ext::pallet_prelude::ExtendedHeaderFor<System>,
			Hash = System::Hash,
		>,
		Context: Default,
		UnsignedValidator,
	...
	UnsignedValidator: ValidateUnsigned<Call = CallOf<Block::Extrinsic, Context>>,
{
	...
	pub fn try_execute_block(
		...
		{
			let new_header = <frame_system_ext::Pallet<System>>::finalize();
	...
	UnsignedValidator: ValidateUnsigned<Call = CallOf<Block::Extrinsic, Context>>,
{
	...
	pub fn finalize_block() -> frame_system_ext::pallet_prelude::ExtendedHeaderFor<System> {
		sp_io::init_tracing();
		...
		<frame_system_ext::Pallet<System>>::finalize()
	}
	...
	fn final_checks(header: &frame_system_ext::pallet_prelude::ExtendedHeaderFor<System>) {
