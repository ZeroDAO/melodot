...
//! # use frame_executive_ext as executive;
...
impl<
		...
		Block: traits::Block<Header = System::ExtendedHeader, Hash = System::Hash>,
		Context: Default,
		UnsignedValidator,
	...
	UnsignedValidator: ValidateUnsigned<Call = CallOf<Block::Extrinsic, Context>>,
{
	...
	pub fn initialize_block(header: &System::ExtendedHeader) {
		sp_io::init_tracing();
	...
	fn extract_pre_digest(header: &System::ExtendedHeader) -> Digest {
	...
	/// except state-root.
	pub fn finalize_block() -> System::ExtendedHeader {
		sp_io::init_tracing();
	...
	fn final_checks(header: &System::ExtendedHeader) {
...
mod tests {
	...
	fn block_weight_and_size_is_stored_per_tx() {
		...
		t.execute_with(|| {
			...
			let _ = <frame_system_ext::Pallet<Runtime>>::finalize();
